export const me = {
  name: "Natenael Temesgen",
  role: "Senior Frontend Architect",
  // Fixed the path: Removed the extra dot and the comment from inside the string
  cvLink: "/blue_Minimalist_modern_CV_resume.pdf", 
  ...
  socials: {
    ...
    linkedin: "https://linkedin.com/in/Natenaeltemesgen",
    twitter: "https://twitter.com/NatenaelTe93097" // Removed the '@' from the URL path for a cleaner link
  }
};